...
from .views import ExperienceList, ExperienceDetail, CertificateList, CertificateDetail, SocialMediaList, \
    SocialMediaDetail
...
urlpatterns = [
    ...
    # Certification urls
    path("certificate/<int:pk>/", CertificateDetail.as_view(), name="certificate-detail"),
